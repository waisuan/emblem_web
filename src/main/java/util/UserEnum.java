...
public enum UserEnum {
  USERNAME("Username"), PASSWORD("Password"), CAN_CREATE("Add"), CAN_EDIT("Edit"), CAN_DELETE(
      "Delete"), CAN_SEARCH("Search"), SALT("Salt"), ALREADY_LOGGED_ON("Logged On"), DATE_OF_CREATION(
      "Date of Creation"), IS_ADMIN("Admin"), LAST_UPDATED("Last Updated");
